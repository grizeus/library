...
/// @return integer value of converted string or 0 if conversion fails. If the converted value is out of range of
/// int (INT_MAX = 2147483647 & INT_MIN = -2147483648), the return value is this range limit depending on the sign of the
/// value.
